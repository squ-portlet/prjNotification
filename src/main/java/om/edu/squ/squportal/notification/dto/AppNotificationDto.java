...
public class AppNotificationDto
{
	 ...
	 * @param msg_subject the msg_subject to set
	 * 
	 * Date          : Jul 10, 2017 9:42:59 AM
	 */
	...
	{
		return "AppNotificationDto [medium=" + medium + ", response="
				+ response + ", toAddress=" + toAddress + ", msg_subject="
				+ msg_subject + ", msg_text=" + msg_text + ", lang=" + lang
				+ ", dateSent=" + dateSent + ", appName=" + appName
				+ ", appRef=" + appRef + ", refKey=" + refKey + ", comments="
				+ comments + "]";
	}
